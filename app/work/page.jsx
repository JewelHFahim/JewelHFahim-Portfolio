...
const projects = [
  ...
  },
  {
    ...
    title: "project 2",
    description:
      "Worked as a Frontend Developer on MyProWorker, a freelancer marketplace platform. Built responsive dashboards, job listings, and user flows using React, Vite, Tailwind CSS, and Redux Toolkit, with smooth form handling and UI interactions powered by React Hook Form, Draft.js, and related libraries.",
    stack: [
      { name: "React" },
      { name: "Vite" },
      { name: "Tailwind CSS" },
...

  {
    ...
    title: "project 4",
    description:
      "HyperSpeed is a car servicing and auto-parts website built with Next.js, featuring an embedded query system via iframe where users can filter parts by car model, tire type, and rim size. Developed a responsive, modern UI with smooth interactions and dynamic filtering for a seamless browsing experien",
    stack: [
      { name: "React" },
      { name: "Next.js" },
      { name: "Tailwind CSS" },
...

  {
    ...
    title: "project 5",
    description:
      "Backend for Ferry Wheel, a real-time multiplayer betting game. Built with TypeScript, Node.js, Express, MongoDB, Socket.io, and Redis to handle round management, betting logic, and live event broadcasting. Implemented JWT-based auth, role-based access, secure configuration with dotenv, and structured logging using Winston and daily log rotation for production monitoring.",
    stack: [
      { name: "Tailwind" },
      { name: "Node.js" },
      { name: "Express" },
    ...
    image: "/assets/FerryWeel.PNG",
    live: "https://ferry-wheel-game.vercel.app/",
    github: "",
  },
];
